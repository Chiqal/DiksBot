...
cl.login(token="EnoQW6jom2Ub1KpdTKb9.fbMcAjl5m9eOdy9zPiwPkq.cTZD1Su7smMKzbxWz42tEQzGg+rjSs2HgZs5JdcAbuI=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="Endz0UbfXt9fKs0bl9Na.jRtusaIE4DcH+SxjLmsK6G.sbbwM784nP0nc20+WnT86OQJEL3YDBVh/HAwG1XnpTI=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="Enw5LEvOlF9qvqrQTgB0.EaAcuovi80UBqbkxEcw4ia.slk++YSi4idP222ZAgCH+dRX7Z+C5wUCrWLsdNl/+Mw=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Enc3Y9HT7veRfGYSmgY6.eplTeWyMNHFdEPB9X26hDG.l8i6pQf/k9Vgw1+wSUViOncH0Zl3okznuh1WgxQ/Hpw=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="En8IHPl2fKtmL6dOAsZe.+urLDlQgcsoUTdJjm8G2ZG.Qqq2+CLMKw/R5xrXpfce4yGLqnW1gacXKnrRRC15inY=")
ks.loginResult()
...
helpMessaDone"""Syndicate Protect
Owner : ✰A ChiqaLFV✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
Creator:
Idline: http://line.me/ti/p/~chiqaladiksa""",
    "lang":"JP",
    ...
    "dblack":False,
    "clock":False,
    "cName":"SYNDICATE Ｔｅａｍ ",
    "cName2":"SYNDICATE Ｔｅａｍ ",
    "cName3":"SYNDICATE Ｔｅａｍ ",
    "cName4":"SYNDICATE Ｔｅａｍ ",
    "cName5":"SYNDICATE Ｔｅａｍ ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Jablay\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","In","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Syn leave","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Synout"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"Selamat datang di Group BIG SiF FAMILY")
                cl.sendText(msg.to,"Jangan nakal ok!, dan budayakan baca note ya kak 😚😚")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"kang Sayur On")
                ki.sendText(msg.to,"kang Colli On")
                kk.sendText(msg.to,"kang Modus On")
                kc.sendText(msg.to,"kang Cabul On")
                ks.sendText(msg.to,"kang boker On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Paling Kasep Pokoknya 😜")
    ...
    for zx in range(0,100):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Done✔")
          print "Like"
        except:
          pass
      else:
